...
const MainMint = ({accounts, setAccounts, toggleComponent}) => {
    ...
    async function handleMint(){
        if(window.ethereum){
            ...
            const contract = new ethers.Contract(contractAddress, PixelPaws.abi, signer);   // get the smart contract
            ...
            try {
                const response = await contract.mint(BigNumber.from(mintAmount), {
                    value: ethers.utils.parseEther((0.05*BigNumber.from(mintAmount)).toString()),
                  });
